    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full border-b flex-1 flex-col gap-6 p-4 md:p-6">
            ...
            <DataHeader
                variant="profile"
                :title="pageTitle"
                subtitle="Create a new employee within the organization."
                badge-text="New"
            ...
            <div class="mx-auto w-full max-w-4xl">
                <Card class="border-dashed">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Fill in the information below to create a new employee. All fields marked with <span class="text-destructive">*</span> are required.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
